...
@AndroidEntryPoint
class PackagesFragment : BaseFragment(), TextWatcher {

    var binding: FragmentPackagesBinding by autoCleared()
    var type = 0
    ...
    private fun setData() {
        ...
        binding.btnBuyNow.setOnClickListener {
            if (type != 0) {
                findNavController().navigate(R.id.action_packagesFragment_to_buyFragment)
            }else{
                showErrorToast("اختر باقة الإعلانات")
            }
        }
    }
