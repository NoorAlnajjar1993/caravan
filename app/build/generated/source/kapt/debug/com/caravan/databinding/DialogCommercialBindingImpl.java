...
public class DialogCommercialBindingImpl extends DialogCommercialBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView_071, 5);
        sViewsWithIds.put(R.id.textView_07, 6);
        sViewsWithIds.put(R.id.textView_08, 7);
        sViewsWithIds.put(R.id.textView_11, 8);
    }
    // views
    @NonNull
    ...
    public DialogCommercialBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private DialogCommercialBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
