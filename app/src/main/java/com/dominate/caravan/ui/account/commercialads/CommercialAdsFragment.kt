...
import com.dominate.caravan.ui.account.commercialads.adapter.MyAdsCommercialAdapter
...
class CommercialAdsFragment : BaseFragment(), TextWatcher {
    ...
    private val viewModel: CommercialAdsViewModel by viewModels()
    var token: String? = ""
    lateinit var myAdsAdapter: MyAdsCommercialAdapter
    ...
    private fun setData() {
        ...
        binding.textView02.text  = "اعلاناتي التجارية"
        try {
    ...
    private fun observeEffective() {
        ...
        viewModel.getEffectiveCommercial(token = token!!)
                ...
                if (it.data?.status?.code == 200) {
                    it.data!!.let { it ->
                        if (it.results.isNotEmpty()) {
                            ...
                            binding.animationView.visibility = View.GONE
                            myAdsAdapter = MyAdsCommercialAdapter(it.results) {}
    ...
    private fun observeUnderReview() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getPendingCommercial(token = token!!)
    ...
    private fun observePaused() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getPausedCommercial(token = token!!)
    ...
    private fun observeRejected() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getRejectedCommercial(token = token!!)
