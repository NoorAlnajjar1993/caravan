...
public class RowCommertcialEstateSingleBindingImpl extends RowCommertcialEstateSingleBinding  {
    ...
    public RowCommertcialEstateSingleBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private RowCommertcialEstateSingleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.dominate.caravan.medule.home.CommercialEstate) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.dominate.caravan.medule.home.CommercialEstate Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        int itemNumberOfBed = 0;
        com.dominate.caravan.medule.home.CommercialEstate item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read String.valueOf(item.number_of_bed)
                stringValueOfItemNumberOfBed = java.lang.String.valueOf(itemNumberOfBed);
                // read String.valueOf(item.land_area)
                stringValueOfItemLandArea = java.lang.String.valueOf(itemLandArea);
                ...
                // read ((String.valueOf(item.number_of_bed)) + (' ')) + (@android:string/room)
                ...
                // read ((String.valueOf(item.land_area)) + (' ')) + (@android:string/m2)
