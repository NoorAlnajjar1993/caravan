...
import com.caravan.databinding.FragmentTalkThrough3Binding
import com.dominate.caravan.core.base.BaseFragment
import com.dominate.caravan.ui.home.HomeActivity

class TalkThrough3Fragment : BaseFragment() {

    lateinit var binding: FragmentTalkThrough3Binding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentTalkThrough3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setData(){
        ...
        binding.btnNext.setOnClickListener {
            findNavController().navigate(R.id.action_talkThrough3Fragment_to_homeFragment)
        }
