...
public final class FragmentCommercialEstateBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCommercialEstateBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout constraintLayout01, @NonNull AppCompatImageView ivBack,
      @NonNull RecyclerView rvCommercialEstates, @NonNull AppCompatTextView textView02) {
  ...
  @NonNull
  public static FragmentCommercialEstateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCommercialEstateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_commercial_estate, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCommercialEstateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCommercialEstateBinding((ConstraintLayout) rootView, constraintLayout01,
          ivBack, rvCommercialEstates, textView02);
    }
