...
public abstract class RowCommertcialEstateBinding extends ViewDataBinding {
  ...
  @NonNull
  public static RowCommertcialEstateBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.row_commertcial_estate, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static RowCommertcialEstateBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<RowCommertcialEstateBinding>inflateInternal(inflater, R.layout.row_commertcial_estate, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.row_commertcial_estate, null, false, component)
   */
  @NonNull
  @Deprecated
  public static RowCommertcialEstateBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<RowCommertcialEstateBinding>inflateInternal(inflater, R.layout.row_commertcial_estate, null, false, component);
  }

  public static RowCommertcialEstateBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static RowCommertcialEstateBinding bind(@NonNull View view, @Nullable Object component) {
    return (RowCommertcialEstateBinding)bind(component, view, R.layout.row_commertcial_estate);
  }
}
