...
class RealEstateAdsFragment : BaseFragment(), TextWatcher {
    ...
    private fun setData() {
        ...
        binding.textView02.text  = "اعلاناتي العقارية"
        try {
    ...
    private fun observeEffective() {
        ...
        viewModel.getEffective(token = token!!)
                ...
                if (it.data?.status?.code == 200) {
                    it.data!!.let { it ->
                        if (it.results.isNotEmpty()) {
                            ...
                            binding.animationView.visibility = View.GONE
                            myAdsAdapter = MyAdsAdapter(it.results) {}
    ...
    private fun observeUnderReview() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getPending(token = token!!)
    ...
    private fun observePaused() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getPaused(token = token!!)
    ...
    private fun observeRejected() {
        ...
        binding.animationView.visibility = View.GONE
        binding.tvNoAds.visibility = View.GONE
        viewModel.getRejected(token = token!!)
