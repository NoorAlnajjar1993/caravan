...
public abstract class Hilt_TermOfUseFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    ((TermOfUseFragment_GeneratedInjector) this.generatedComponent()).injectTermOfUseFragment(UnsafeCasts.<TermOfUseFragment>unsafeCast(this));
  }
