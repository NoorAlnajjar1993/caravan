...
import com.caravan.databinding.FragmentCliqBinding
...
@AndroidEntryPoint
class CliqFragment : BaseFragment(), TextWatcher {

    var binding: FragmentCliqBinding by autoCleared()
    var type = 0
    ...
    override fun onCreateView(
        ...
        binding = FragmentCliqBinding.inflate(inflater, container, false)
